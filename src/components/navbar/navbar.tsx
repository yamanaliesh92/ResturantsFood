...
const Navbar: FC<IProps> = ({ active }) => {
  ...
  return (
    <div className="block sm:flex sm:items-center">
      ...
      {restaurantId === 0 ? (
        <Link
          className="font-[500] sm:text-[12px] md:text-[14px] text-dark dark:text-white ml-1 cursor-pointer sm:px-1 md:px-3"
        ...
        <div className="flex flex-col mt-3 sm:mt-0 mr-0 sm:mr-2  sm:flex-row items-center ">
          <Link
            className="font-[500] mx-0 sm:mx-2 sm:text-[12px] md:text-[14px]  text-dark dark:text-white cursor-pointer sm:px-1 md:px-3"
            to={"/dashboard/products/new"}
          >
            Create Order
          </Link>
          <Link
            className="font-[500] mt-10 sm:mt-0 sm:text-[12px] md:text-[14px]  text-dark dark:text-white  cursor-pointer sm:px-1 md:px-3"
            to={"/dashboard/orders"}
          >
            To Dashboard
          </Link>
